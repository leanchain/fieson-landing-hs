...
- Which third-party processors are involved in the processing of personal data.
- To which third parties personal data is transmitted.
- Further information such as storage duration, data subject rights, and other details to help inform about the described data processing.
...
Webflow uses Content Delivery Network (CDN) providers like Fastly, Amazon CloudFront, or Cloudflare to deliver website content quickly and securely to website visitors.
...
- Company
- **Contact data**
- Information you provide to the AI assistant via voice
...
- Interest based on the legal basis: Providing or testing the offered services.
...
- **Email address**
- Information you provide to us via email
...
- Interest based on the legal basis: Asking and answering questions about products, services, and other offerings.
...
- Additional information you provide in free text
...
- We use **YouTube Embeds** to display YouTube videos directly on our website. When you visit a page with an embedded video, your browser automatically connects to the servers of YouTube, a Google subsidiary. When connecting to Google's servers, various personal data may be transmitted depending on your settings. If you are logged into YouTube at the time of your visit, data you have already provided directly to YouTube may also be transmitted.
...
Data may be disclosed, where necessary, to the following categories of recipients:
...
- **Right to Data Portability:** You have the right to request a copy of your data in a structured, common, and machine-readable format to be sent to you or another party.
